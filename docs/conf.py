#!/usr/bin/env python
#
# wrapinstance documentation build configuration file, created by sphinx-quickstart.
#
...
version = wrapinstance.__version__
# The full version, including alpha/beta/rc tags.
release = wrapinstance.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(wrapinstance.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "wrapinstance/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/wrapinstance/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "wrapinstancedoc"
